                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_input(array('id' => 'nama', 'name' => 'nama', 'type' => 'text', 'value' => $nama, 'class' => 'form-control')); ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_input(array('id' => 'golongan_darah', 'name' => 'golongan_darah', 'type' => 'text', 'value' => $golongan_darah, 'class' => 'form-control')); ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_textarea(array('id' => 'alamat', 'name' => 'alamat', 'type' => 'textarea', 'value' => $alamat, 'rows' => '4', 'class' => 'form-control')); ?>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div align="right">
                                    ...
                                    <script type="text/javascript">
                                        function tab1Show() {
                                            ...
                                            //     // if(is_cetak)
                                            //         window.open('<?php // echo site_url('periksamedis/cetak_sksehat');
                                                                    ?>', '_blank');
                                        }
                                    </script>
                                </div>
