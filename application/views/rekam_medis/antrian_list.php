...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#tableAnak").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "../periksamedis/json_antrian/2",
                "type": "POST"
            },
            columns: [{
                    "data": "no_pendaftaran",
        ...
        var t = $("#tableHamil").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "../periksamedis/json_antrian/3",
                "type": "POST"
            },
            columns: [{
                    "data": "no_pendaftaran",
        ...
        var t = $("#tableJasa").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "../periksamedis/json_antrian/5",
                "type": "POST"
            },
            columns: [{
                    "data": "no_pendaftaran",
        ...
        var t = $("#tableLab").dataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "../periksamedis/json_antrian/6",
                "type": "POST"
            },
            columns: [{
                    "data": "no_pendaftaran",
