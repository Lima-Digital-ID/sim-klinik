    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'id_klinik' => $this->input->post('id_user_level', TRUE) != 1 ? $this->input->post('id_klinik', TRUE) : 0,
                'id_dokter' => $this->input->post('id_user_level', TRUE) == 5 ? $this->input->post('id_dokter', TRUE) : 0,
                'id_perawat' => $this->input->post('id_user_level', TRUE) == 11 ? 1 : 0,
            );
